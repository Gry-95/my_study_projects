...
def dinam_rout(request, name_post):
    date = {
        'post_name': name_post
    }
    return render(request, 'blog/detail_by_name.html', context=date)


def num_of_post(request, number_post):
    date = {
        'post_num': number_post
    }
    return render(request, 'blog/detail_by_number.html', context=date)
...
def main_page(request):
    ...
    return render(request, 'blog/index.html', context=date)
...
def view_first_blog(request):
    date = {
        'year_born': 1991,
        'city_born': 'Виницца',
        'movie_name': 'Груз200',
    }
    return render(request, 'blog/Kianu_Rivz.html', context=date)
